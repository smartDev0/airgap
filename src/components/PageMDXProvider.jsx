...
import styles from './PageMDXProvider.module.scss';
...
const PageMDXProvider = ({ children }) => (
    <>
        <MDXProvider
            components={{
                h1: Heading2,
...
PageMDXProvider.propTypes = propTypes;
PageMDXProvider.defaultProps = defaultProps;

export default PageMDXProvider;
